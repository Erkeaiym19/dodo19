...
// const closeVybrait = document.getElementById('close-vybrait')
// const vybrait = document.querySelector('.vybrait1')
// const knopka = document.querySelectorAll('.knopka')

// closeVybrait.addEventListener('click',()=> {
//     hideVybrait()
// })
// vybrait.addEventListener('click', (event) => {
//     if(event.target.className === 'vybrait1'){
//         hideVybrait()
//     }
// })
// function hideVybrait(){
//     vybrait.style.display = 'none';
// }
